...
def fetch_metro_updates():
    """Fetch metro trip updates and save to JSON file."""
    url = "https://api.transport.nsw.gov.au/v1/gtfs/realtime/metro"
    headers = {
    ...
    try:
        ...
        parse_trip_updates(tmp_path, "metro")
        import os as os_module
        os_module.unlink(tmp_path)  # Delete temp file
        print(f"✅ Metro trip updates stored to database")
        return True
