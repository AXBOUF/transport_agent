...
from parser import parse_vehicle_positions

API_KEY = os.getenv("TRANSPORT_NSW_API_KEY")

def fetch_metro_positions():
    """Fetch metro vehicle positions and save to JSON file."""
    ...
    try:
        ...
        parse_vehicle_positions(tmp_path, "metro")
        import os as os_module
        os_module.unlink(tmp_path)  # Delete temp file
        print(f"✅ Metro vehicle positions stored to database")
        return True
