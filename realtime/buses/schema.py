"""
Buses Real-Time Data Schema
Separate database for Buses real-time feeds
"""
import sqlite3
from datetime import datetime
from pathlib import Path

DB_PATH = Path(__file__).parent / "realtime_data_buses.db"

def init_db():
    """Initialize database schema for Buses"""
    ...
    conn.commit()
    conn.close()
    print(f"✅ Buses database initialized at {DB_PATH}")

def get_connection():
    """Get database connection for Buses"""
